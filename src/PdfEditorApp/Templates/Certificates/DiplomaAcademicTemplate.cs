...
public class DiplomaAcademicTemplate : ITemplateDefinition
{
    ...
    public PdfDocumentModel Create()
    {
        var doc = new PdfDocumentModel
        {
            ...
            Author = "CodeFryDev Institute of Technology",
        ...
        var page = new PdfPageModel
        {
            ...
            Elements = new List<PdfElementBase>
            {
                ...
                new PdfTextElement
                {
                    ...
                    Width = 931,
                    Height = 58,
                    Text = "CODEFRYDEV INSTITUTE OF TECHNOLOGY",
                    FontSize = 36,
                    FontFamily = "Cinzel",
                    IsBold = true,
                    TextColorHex = "#1E293B",
                ...
                new PdfTextElement
                {
                    ...
                    Width = 260,
                    Height = 24,
                    Text = "President of the Institute",
                    FontSize = 11,
                    FontFamily = "Cinzel",
                    IsBold = true,
                    TextColorHex = "#78350F",
                ...
                new PdfTextElement
                {
                    ...
                    Width = 931,
                    Height = 22,
                    Text = "Degree Serial No: CFD-MS-2026-948102 • Conferred June 15, 2026 • Verified by CodeFryDev Academic Registry",
                    FontSize = 8.5,
